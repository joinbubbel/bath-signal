...
const createCallButton = document.getElementById("create_call") as HTMLButtonElement;
const joinCallButton = document.getElementById("join_call") as HTMLButtonElement;
...
createCallButton.onclick = async () => {
    ...
    let session = joinCall(video, userId, callId);
